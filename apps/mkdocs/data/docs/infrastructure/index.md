...
| **k3s Server Configuration** | The drop-ins under `/etc/rancher/k3s/config.yaml.d/` and the Flux-managed Secrets k3s reads; today, etcd snapshots to R2. | [Read more](k3s-server-config.md) |
